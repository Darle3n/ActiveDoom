...
```text
                           +--------------------------------------+
                           |            Windows Host              |
                           |  VirtualBox + Splunk Enterprise      |
                           |  Splunk Web:  http://localhost:8000  |
                           |  Splunk Mgmt: https://localhost:8089 |
                           |  Ingest:      192.168.180.1:9997     |
                           +-------------------+------------------+
                                               |
                                               | Host-only network
                                               | 192.168.180.0/24
        ...
        v                          v                       v                          v
  +------------------+     +------------------+    +-----------------+     +------------------+
  |      DC01        |     |    CLIENT01      |    |     KALI01      |     |   Host-only NIC  |
  | 192.168.180.10   |     | 192.168.180.20   |    | 192.168.180.30  |     |   on the host    |
  | UF -> 9997       |     | UF -> 9997       |    | attacker tools  |     |                  |
  +------------------+     +------------------+    +-----------------+     +------------------+
```
